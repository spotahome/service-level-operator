...
func (_m *API) LabelNames(ctx context.Context) ([]string, api.Warnings, error) {
	ret := _m.Called(ctx)
...
func (_m *API) LabelValues(ctx context.Context, label string) (model.LabelValues, api.Warnings, error) {
