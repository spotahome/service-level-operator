...
type Service interface {
	...
	// ObserveOuputCreateDuration measures the duration of the process of creating the output for the SLO
	ObserveOuputCreateDuration(slo *measurev1alpha1.SLO, kind string, startTime time.Time)
	// IncOuputCreateError will increment the number of errors on the SLO output creation.
	IncOuputCreateError(slo *measurev1alpha1.SLO, kind string)
}
