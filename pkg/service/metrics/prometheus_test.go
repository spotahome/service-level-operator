	...
	tests := []struct {
	...
	}{
		{
			...
			addMetrics: func(s metrics.Service) {
				now := time.Now()
				s.IncSSLOOuputCreateError(nil, kind)
				s.IncSSLOOuputCreateError(nil, kind)
				s.ObserveSLOOuputCreateDuration(nil, kind, now.Add(-6*time.Second))
				s.ObserveSLOOuputCreateDuration(nil, kind, now.Add(-27*time.Millisecond))
			},
			expMetrics: []string{
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="0.005"} 0`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="0.01"} 0`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="0.025"} 0`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="0.05"} 1`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="0.1"} 1`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="0.25"} 1`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="0.5"} 1`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="1"} 1`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="2.5"} 1`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="5"} 1`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="10"} 2`,
				`service_level_processing_slo_output_create_duration_seconds_bucket{kind="test",le="+Inf"} 2`,
				`service_level_processing_slo_output_create_duration_seconds_count{kind="test"} 2`,

				`service_level_processing_slo_output_create_failures_total{kind="test"} 2`,
			},
			expCode: 200,
		},
		{
