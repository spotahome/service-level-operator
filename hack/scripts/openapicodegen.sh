...
PROJECT_PACKAGE=github.com/slok/service-level-operator
...
docker run -it --rm \
    ...
    -e CRD_PACKAGES=${PROJECT_PACKAGE}/pkg/apis/measure/v1alpha1 \
    -e OPENAPI_OUTPUT_PACKAGE=${PROJECT_PACKAGE}/pkg/apis/measure/v1alpha1 \
